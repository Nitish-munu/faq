...
@Controller
//service and other annotation can not be used only @controller is used in controllerclass
@AllArgsConstructor
public class FaqController {
    ...
    // @Autowired    //it bring object and give to you
    ...
    // @Autowired  //it has written upto  spring 2.4
    // public FaqController(FaqService service) {
    //     this.service = service;
    // }

    // private final FaqService service; // final is used because it never be changed again
    ...
    // return new String[] {
    // "What are the main differences between Java's ArrayList and LinkedList in
    // terms of performance and use cases?",
    // "How does Java handle exception handling with try-catch blocks and what is
    // the purpose of the finally block?",
    // "In Spring Boot, what are the primary purposes of the @SpringBootApplication
    // annotation and what does it combine?",
    // "How do you manage dependencies and configuration in a Spring Boot
    // application using application.properties or application.yml?",
    // "What are Spring Boot's major advantages for building microservices and how
    // does it support features like service discovery and load balancing?"
    // };
    // }
